...
set genomeRtd $env(RT_TMP)/22E197F1300.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {LUT_Module__GB1}]"
...
set genomeName [subst -nocommands -novariables {LUT_Module__GB1}]
