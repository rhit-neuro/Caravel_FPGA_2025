...
#
# Script generated by Vivado on Mon Mar 31 17:53:19 EDT 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DualPortMemory.sh
...
#
# Usage        : DualPortMemory.sh
#                DualPortMemory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DualPortMemory.sh [-reset_run]
#                DualPortMemory.sh [-reset_log]
#                DualPortMemory.sh [-help]
#
...
#                script (type 'DualPortMemory.sh -help' for more information).
#
...
# script info
echo -e "DualPortMemory.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DualPortMemory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DualPortMemory xil_defaultlib.glbl -o DualPortMemory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DualPortMemory_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/beandog/senior-design/Caravel_FPGA_2025/CARAVEL/CARAVEL.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key DualPortMemory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DualPortMemory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DualPortMemory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DualPortMemory.sh [-help]\n\
Usage: DualPortMemory.sh [-step]\n\
Usage: DualPortMemory.sh [-lib_map_path]\n\
Usage: DualPortMemory.sh [-reset_run]\n\
Usage: DualPortMemory.sh [-reset_log]\n\
Usage: DualPortMemory.sh [-keep_index]\n\
Usage: DualPortMemory.sh [-noclean_files]\n\n\
