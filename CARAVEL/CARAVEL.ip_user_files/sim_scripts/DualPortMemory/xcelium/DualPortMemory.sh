...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DualPortMemory xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DualPortMemory -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/beandog/senior-design/Caravel_FPGA_2025/CARAVEL/CARAVEL.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DualPortMemory_sc.so .tmp_log xcelium_lib waves.shm c.obj)
